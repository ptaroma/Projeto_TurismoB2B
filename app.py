...
CITY_NAME_OVERRIDES = {
    ...
    "jose dos campos": "José dos Campos",
    "jundiai": "Jundiaí",
    "juruti": "Juruti",
    ...
    "suia micu": "Suiá-Miçu",
    "tabatinga": "Tabatinga",
    "taboão da serra": "Taboão da Serra",
...
def format_airport_display(iata: str, city: str, name: str) -> tuple[str, str]:
    city_display = CITY_DISPLAY_OVERRIDES.get(iata) or CITY_NAME_OVERRIDES.get(normalize_text(city)) or accentify_text(city)
